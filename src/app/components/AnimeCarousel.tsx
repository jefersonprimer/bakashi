...
import MaturityRating from '../components/MaturityRating'; // Ajuste o caminho conforme necessário
import { Anime } from '../../types'; // Importando a interface Anime
...
const AnimeCarousel: React.FC<AnimeCarouselProps> = ({ animes, itemsPerPage = 5 }) => {
          ...
          <div key={anime.id} className={styles.animeCard}>
            ...
            <div className={styles.cardInfo}>
              ...
              <p className={styles.infoText}>
                ...
                {anime.score} <FontAwesomeIcon icon={faStar} className={styles.iconStar} />
              </p>
