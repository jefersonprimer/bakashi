...
const WatchlistButton: React.FC<WatchlistButtonProps> = ({ anime, addToWatchlist }) => {
  const router = useRouter();

  const handleAddToWatchlist = () => {
    addToWatchlist(anime); // Adiciona o anime à lista
    router.push("/watchlist"); // Redireciona para a página /watchlist
  };
