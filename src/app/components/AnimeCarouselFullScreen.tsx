...
const AnimeCarouselFullScreen: React.FC<AnimeCarouselFullScreenProps> = ({ animes }) => {
  ...
  const prevPage = () => {
    setCurrentIndex(prevIndex => (prevIndex - 1 + thumbnailAnimes.length) % thumbnailAnimes.length);
  };
  ...
  return (
    <div className={styles.carouselContainer}>
      <div
        ...
        style={{ backgroundImage: `url(${thumbnailAnimes[currentIndex].imageThumbnail})` }}
      />

      <div className={styles.cardContainer}>
        <div className={styles.cardContent}>
          <div className={styles.leftColumn}>
            <MaturityRating rating={thumbnailAnimes[currentIndex].rating} /> {thumbnailAnimes[currentIndex].audioType} {thumbnailAnimes[currentIndex].genres.join(", ")}
            <p className={styles.name}>{thumbnailAnimes[currentIndex].name}</p>
            <p className={styles.synopsis}>{thumbnailAnimes[currentIndex].synopsis}</p>
            ...
            <div className={styles.buttonsContainer}>
              ...
              <div className={styles.buttonBookmark}>
                <div className={styles.tooltip}>
                  ...
                  <svg className={styles.iconBookmark} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-labelledby="watchlist-svg" role="img">
      ...
      <div className={styles.navigationButtons}>
        <button className={styles.arrowButton} onClick={prevPage} aria-label="Previous Item">
          <FontAwesomeIcon icon={faChevronLeft} />
        </button>
        <button className={styles.arrowButton} onClick={nextPage} aria-label="Next Item">
